...
\Satz
Die Zusammenhängenden Teilmengen von $\mathbb{R}$ sind genau die Intervalle: \newline
$M \subset \mathbb{R} \text{ Zusammenhängend } \Leftrightarrow$ M ist ein Intervall
...
Sei $f: D \rightarrow \mathbb{R}$ \hyperref[def:Stetig]{stetig} und $D \subset \mathbb{R}^n$ zusammenhängend

$\Rightarrow f(D) \subset \mathbb{R}$ ist zusammenhängend. 
